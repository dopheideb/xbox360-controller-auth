...
Overview of which data is exchanged:
| Stage                                       | Host                                       | Device                                           | Encryption
|---------------------------------------------|--------------------------------------------|--------------------------------------------------|------------
...
| Xbox 360 controller by Harmonix | `49 4b 00 00 17` | `84 3d 35 33 16 d6 33 28 23 03 20 00` | `00 80` | `82`          | `ad 1b`   | `01 fa`    | `03 00 01 01` | `28`     | https://brandonw.net/360bridge/Xbox360WiredController.xlsx
...
4. `03 00`, meaning unknown, but seems to be an error condition. Seen when not using 0x1D+0x1E keys.
